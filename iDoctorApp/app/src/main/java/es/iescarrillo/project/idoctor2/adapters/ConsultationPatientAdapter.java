...
public class ConsultationPatientAdapter extends ArrayAdapter<Consultation> {
    //Custom adapter for displaying manager classrooms in a ListView.
    public ConsultationPatientAdapter(Context context, List<Consultation> consultations) {
    ...
    public View getView(int position, View convertView, ViewGroup parent){
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(getContext()).inflate(R.layout.item_list_consultation_professional_patient, parent , false);
        }
