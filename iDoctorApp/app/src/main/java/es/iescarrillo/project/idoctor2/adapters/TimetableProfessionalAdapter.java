...
public class TimetableProfessionalAdapter extends ArrayAdapter<Timetable> {
    public TimetableProfessionalAdapter(Context context, List<Timetable> timetableList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent){
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(getContext()).inflate(R.layout.item_timetable_professional, parent , false);
        }
